...
class SignUpActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            userNameTIET.setOnFocusChangeListener { _, hasFocus ->
                if (hasFocus) {
                    genderSelectionBtn.strokeColor = ColorStateList.valueOf(activityContext.getColorResource(R.color.subColor))
                }
            }
        ...
        binding.apply {
            when (view?.id) {
                R.id.genderSelectionBtn -> {
                    ...
                    genderSelectionBtn.strokeColor = ColorStateList.valueOf(activityContext.getColorResource(R.color.defaultColor))
                ...
                R.id.signUpButton -> {
                    ...
                    if (emailOrUserName.isEmpty()) {
                        ...
                        userNameTIL.error = null
                        passwordTIL.error = null
                        passwordTIL.error = getString(com.example.core.R.string.password_is_too_long_text)
                    } else if (selectedGender == 0) {
                        userNameTIL.error = null
                        passwordTIL.error = null
                        toastController.showToast(activityContext, getString(com.example.core.R.string.select_gender_text), false)
                    } else if (securityAnswer.isEmpty()) {
                        userNameTIL.error = null
                        passwordTIL.error = null
                        toastController.showToast(activityContext, getString(com.example.core.R.string.select_security_question_text), false)
                    } else {
                        userNameTIL.error = null
                        passwordTIL.error = null
                        ...
                        prefs.saveUserCredentials(
                            emailOrUserName, password, selectedGender, selectedSecurityQuestion, securityAnswer
                        )
                        prefs.rememberMe = false
                        toastController.showToast(activityContext, getString(com.example.core.R.string.sign_up_successfully_toast_message_text), true)
                        finish()
                    }
                }
                R.id.signInTV -> finish()
    ...
    private fun showCustomPopup(view: View, fromWhereInvoked: Int) {
        ...
        if (fromWhereInvoked == 1) {
            ...
            customPopupMenuLayoutBinding.apply {
            ...
            securityQuestionsArrayList.apply {
    ...
    private fun showSecurityQuestionsDialog() {
        ...
        securityQuestionDialogBuilder.apply {
        ...
        if (!activityContext.isFinishing && !activityContext.isDestroyed && !securityQuestionAlertDialog.isShowing) {
            securityQuestionAlertDialog.apply {
        ...
        securityQuestionDialogLayoutBinding.apply {
            if (prefs.isDarkModeEnable) {
            ...
            securityQuestionBtn.setOnClickListener { view: View ->
                securityQuestionBtn.strokeColor = ColorStateList.valueOf(activityContext.getColorResource(R.color.defaultColor))
    ...
    private fun checkGenderAndSecurityQuestion(forWhichInvoked: String?, category: Int) {
        if (forWhichInvoked.equals(other = "Gender", ignoreCase = true)) {
            ...
            binding.apply {
                when (category) {
                    Gender.NONE.ordinal -> {
                        genderSelectionBtn.text = getString(com.example.core.R.string.select_gender_text)
                        genderSelectionBtn.setTextColor(activityContext.getColorResource(R.color.subColor))
                    }

                    Gender.MALE.ordinal -> {
                        genderSelectionBtn.setTextColor(activityContext.getColorResource(R.color.blackAndWhiteViewsColor))
                        genderSelectionBtn.text = getString(com.example.core.R.string.male_text)
                    }

                    Gender.FEMALE.ordinal -> {
                        genderSelectionBtn.setTextColor(activityContext.getColorResource(R.color.blackAndWhiteViewsColor))
                        genderSelectionBtn.text = getString(com.example.core.R.string.fe_male_text)
                    }

                    Gender.TRANSGENDER.ordinal -> {
                        genderSelectionBtn.setTextColor(activityContext.getColorResource(R.color.blackAndWhiteViewsColor))
                        genderSelectionBtn.text = getString(com.example.core.R.string.transgender_text)
                    }
                }
            }
            ...
            securityQuestionDialogLayoutBinding.apply {
                if (category != 0) {
                    securityQuestionBtn.changeVisibility(Visibility.GONE)
                    group1.changeVisibility(Visibility.VISIBLE)
                    selectedSecurityQuestion = category
                    when (category) {
                        SecurityQuestions.QUESTION_1.ordinal -> securityQuestionAnswerTIL.hint = getString(com.example.core.R.string.what_is_your_favourite_book_question)
                        SecurityQuestions.QUESTION_2.ordinal -> securityQuestionAnswerTIL.hint = getString(com.example.core.R.string.what_is_your_favourite_teacher_name_question)
                        SecurityQuestions.QUESTION_3.ordinal -> securityQuestionAnswerTIL.hint = getString(com.example.core.R.string.what_is_your_school_name_question)
                        SecurityQuestions.QUESTION_4.ordinal -> securityQuestionAnswerTIL.hint = getString(com.example.core.R.string.what_is_your_favourite_game_question)
                    }
